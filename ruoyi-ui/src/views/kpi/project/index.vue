  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="项目来源" prop="projectSource">
          <el-input v-model="form.projectSource" placeholder="请输入项目来源" disabled/>
        </el-form-item>
        <el-form-item label="项目编号" prop="projectNumber">
          <el-input v-model="form.projectNumber" placeholder="请输入项目编号" disabled/>
        </el-form-item>
        <el-form-item label="财务资金账户编号" prop="financeAccountNumber">
          <el-input v-model="form.financeAccountNumber" placeholder="请输入财务资金账户编号" disabled/>
        </el-form-item>
        ...
        <el-form-item label="到账经费(万元)" prop="accountExpenditure">
          <el-input v-model="form.accountExpenditure" placeholder="请输入到账经费(万元)" disabled/>
        </el-form-item>
        <el-form-item label="外拨经费(万元)" prop="outExpenditure">
          <el-input v-model="form.outExpenditure" placeholder="请输入外拨经费(万元)" disabled/>
        </el-form-item>
        <el-form-item label="实际经费(万元)" prop="actualExpenditure">
          <el-input v-model="form.actualExpenditure" placeholder="请输入实际经费(万元)" disabled/>
        </el-form-item>
        <el-form-item label="是否首次拨款" prop="isFirstAppropriation" >
          <el-radio-group v-model="form.isFirstAppropriation" disabled>
            <el-radio
              v-for="dict in dict.type.is_first_appropriation"
              :key="dict.value"
              :label="dict.value"
...
<script>
import { listProject, getProject, delProject, addProject, updateProject } from "@/api/kpi/project";
