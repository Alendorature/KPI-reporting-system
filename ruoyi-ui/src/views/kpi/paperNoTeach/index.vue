  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="ISSN号" prop="issnNumber">
        <el-input
          v-model="queryParams.issnNumber"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="论文名称" prop="paperName">
          <el-input v-model="form.paperName" placeholder="请输入论文名称" disabled/>
        </el-form-item>
        <el-form-item label="期刊/会议名称" prop="periodicalName">
          <el-input v-model="form.periodicalName" placeholder="请输入期刊/会议名称" disabled/>
        </el-form-item>
        ...
        <el-form-item label="期卷号" prop="issueNumber">
          <el-input v-model="form.issueNumber" placeholder="请输入期卷号"  disabled/>
        </el-form-item>
        <el-form-item label="ISSN号" prop="issnNumber">
          <el-input v-model="form.issnNumber" placeholder="请输入ISSN号" disabled/>
        </el-form-item>
        <el-form-item label="起止页码" prop="startEndPageNumber">
          <el-input v-model="form.startEndPageNumber" placeholder="请输入起止页码" disabled/>
        </el-form-item>
...
<script>
import { listPaperNoTeach, getPaperNoTeach, delPaperNoTeach, addPaperNoTeach, updatePaperNoTeach } from "@/api/kpi/paperNoTeach";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listPaperNoTeach(this.queryParams).then(response => {
