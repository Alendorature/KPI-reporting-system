  ...
  <div class="app-container">
     ...
     <!-- <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['kpi:intellectual:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="知识产权名称" prop="intellectualName">
          <el-input v-model="form.intellectualName" placeholder="请输入知识产权名称" disabled/>
        </el-form-item>
        <el-form-item label="知识产权编号" prop="intellectualNumber">
          <el-input v-model="form.intellectualNumber" placeholder="请输入知识产权编号" disabled/>
        </el-form-item>
