  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="科技成果名称" prop="scienceName">
          <el-input v-model="form.scienceName" placeholder="请输入科技成果名称" />
        </el-form-item>
        <el-form-item label="科技成果合同编号" prop="scienceNumber">
          <el-input v-model="form.scienceNumber" placeholder="请输入科技成果合同编号" />
        </el-form-item>
        ...
        <el-form-item label="金额（万元）" prop="scienceMoney">
          <el-input v-model="form.scienceMoney" placeholder="请输入金额" />
        </el-form-item>
