  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="论文/讲座名称" prop="excellentPaperChaiName">
          <el-input v-model="form.excellentPaperChaiName" placeholder="请输入论文/讲座名称"  />
        </el-form-item>
      
        <el-form-item label="批准单位" prop="approvingUnit">
          <el-input v-model="form.approvingUnit" placeholder="请输入批准单位"  />
        </el-form-item>
        <el-form-item label="批准时间" prop="approvingTime">
          <el-date-picker clearable 
...
<script>
import { myListChai, getChai, delChai, addChai, updateChai } from "@/api/kpi/chai";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      myListChai(this.queryParams).then(response => {
